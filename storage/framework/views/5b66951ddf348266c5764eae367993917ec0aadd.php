    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo Form::model($pegawaivl,['method'=>'PATCH','route'=>['Pegawai.update',$pegawaivl->id],'files'=>'true']); ?>

                        <label>NIP</label>
                        <input type="text" name="nip" value="<?php echo e($pegawaivl->nip); ?>" class="form-control"><br>
