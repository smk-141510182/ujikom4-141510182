    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a href="<?php echo e(url('/Penggajian')); ?>" class="btn btn-md btn-block">Kembali</a>
                ...
                <div class="panel-body">
                    ...
                    <select name="tunjangan_pegawai_id" class="form-control">
                        ...
                        <?php $__currentLoopData = $tunjanganpegawaivl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
